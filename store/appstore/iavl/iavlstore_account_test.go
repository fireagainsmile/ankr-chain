...
func TestIavlStoreAccountCount(t *testing.T) {
	...
	accInfo1.Amounts = []account.Amount{{account.Currency{Symbol: "ANKR", Decimal: 18}, new(big.Int).SetUint64(100).Bytes()}}
	...
	accInfo2.Amounts = []account.Amount{{account.Currency{Symbol: "ANKR", Decimal: 18}, new(big.Int).SetUint64(100).Bytes()}}
