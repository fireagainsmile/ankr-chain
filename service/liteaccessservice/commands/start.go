...
import (
	...
	lashandler "github.com/Ankr-network/ankr-chain/service/liteaccessservice/handler"
...
func Start() *cobra.Command {
	...
	cmd.Flags().String(lascmm.FlagNode, "tcp://127.0.0.1:26657, http://127.0.0.1:26657 and https://127.0.0.1:443, ", "The node connection address")
